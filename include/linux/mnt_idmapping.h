...
/**
 * vfsuid_into_fs - map a vfsuid into the filesystem idmapping
 * @mnt_userns: the mount's idmapping
 * @fs_userns: the filesystem's idmapping
 ...
 */
static inline kuid_t vfsuid_into_fs(struct user_namespace *mnt_userns,
				    struct user_namespace *fs_userns,
				    vfsuid_t vfsuid)
{
...
static inline bool vfsuid_has_fsmapping(struct user_namespace *mnt_userns,
					...
					vfsuid_t vfsuid)
{
	return uid_valid(vfsuid_into_fs(mnt_userns, fs_userns, vfsuid));
}
...
/**
 * vfsgid_into_fs - map a vfsgid into the filesystem idmapping
 * @mnt_userns: the mount's idmapping
 * @fs_userns: the filesystem's idmapping
 ...
 */
static inline kgid_t vfsgid_into_fs(struct user_namespace *mnt_userns,
				    struct user_namespace *fs_userns,
				    vfsgid_t vfsgid)
{
...
static inline bool vfsgid_has_fsmapping(struct user_namespace *mnt_userns,
					...
					vfsgid_t vfsgid)
{
	return gid_valid(vfsgid_into_fs(mnt_userns, fs_userns, vfsgid));
}

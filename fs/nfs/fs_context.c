...
static const struct fs_parameter_spec nfs_param_specs[] = {
	fsparam_flag  ("ac",		Opt_ac,		NEGATE_WITH_NO),
	...
	fsparam_flag  ("cto",		Opt_cto,	NEGATE_WITH_NO),
	fsparam_flag  ("fg",		Opt_fg),
	fsparam_string("fsc",		Opt_fscache,	NEGATE_WITH_NO, OPTIONAL),
	fsparam_flag  ("hard",		Opt_hard),
	fsparam_flag  ("intr",		Opt_intr,	NEGATE_WITH_NO, IS_DEPRECATED),
	fsparam_enum  ("local_lock",	Opt_local_lock),
	fsparam_flag  ("lock",		Opt_lock,	NEGATE_WITH_NO),
	fsparam_enum  ("lookupcache",	Opt_lookupcache),
	fsparam_flag  ("migration",	Opt_migration,	NEGATE_WITH_NO),
	...
	fsparam_flag  ("posix",		Opt_posix,	NEGATE_WITH_NO),
	fsparam_string("proto",		Opt_proto),
	fsparam_flag  ("rdirplus",	Opt_rdirplus,	NEGATE_WITH_NO),
	fsparam_flag  ("rdma",		Opt_rdma),
	fsparam_flag  ("resvport",	Opt_resvport,	NEGATE_WITH_NO),
	fsparam_u32   ("retrans",	Opt_retrans),
	fsparam_string("retry",		Opt_retry),
	fsparam_u32   ("rsize",		Opt_rsize),
	fsparam_string("sec",		Opt_sec),
	fsparam_flag  ("sharecache",	Opt_sharecache, NEGATE_WITH_NO),

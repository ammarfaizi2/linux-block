...
#define ATOMIC_ACQUIRE_FENCE	".long 0x842bc000\n"
#define ATOMIC_RELEASE_FENCE	".long 0x842dc000\n"
...
#define __bar_bwarw()	asm volatile (ATOMIC_ACQUIRE_FENCE:::"memory")
#define __bar_brwar()	asm volatile (ATOMIC_RELEASE_FENCE:::"memory")

...
#define __SYS_STUB_DECL(abi, name)					\
	long __##abi##_##name(const struct pt_regs *regs)

#define __SYS_STUB0(abi, name)						\
	__SYS_STUB_DECL(abi, name);					\
...
#ifdef CONFIG_X86_64
#define __X64_SYS_STUB_DECL(name)					\
	__SYS_STUB_DECL(x64, sys_##name);
...
#define __IA32_SYS_STUB_DECL(name)					\
	__SYS_STUB_DECL(ia32, sys_##name);
 ...
 * case as well.
 */
#define __IA32_COMPAT_SYS_STUB_DECL(name)				\
	__SYS_STUB_DECL(ia32, compat_sys_##name);
 ...
 */
#define __X32_COMPAT_SYS_STUB_DECL(name)				\
	__SYS_STUB_DECL(x32, compat_sys_##name);
...
#define COMPAT_SYSCALL_DECLARE0(name)					\
	__IA32_COMPAT_SYS_STUB_DECL(name)				\
	__X32_COMPAT_SYS_STUB_DECL(name)				\
	long __typecheck_compat_sys_##name(const struct pt_regs *)
...
#define SYSCALL_DECLARE0(sname)						\
	__X64_SYS_STUB_DECL(sname)					\
	__IA32_SYS_STUB_DECL(sname)					\
	long __typecheck_sys_##sname(const struct pt_regs *)

#define SYSCALL_DECLAREx(x, name, ...)					\
	__X64_SYS_STUB_DECL(name)					\
	__IA32_SYS_STUB_DECL(name)					\
	long __typecheck_sys##name(__MAP(x,__SC_DECL,__VA_ARGS__))

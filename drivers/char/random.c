...
/*
 * This is a max-period LFSR over the 128-bit pool. It assumes
 * that its inputs are non-malicious. It is designed to be much
 * faster than computing a cryptographic hash function, yet
 * still accumulate entropy, though it has no security on its
 * own.
 */

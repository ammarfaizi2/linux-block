...
static const struct ath12k_hw_params ath12k_hw_params[] = {
	{
		...
		.hal_params = &ath12k_hw_hal_params_qcn92xx,
		.rxdma1_enable = false,
...
static int ath12k_init_hw_params(struct ath12k_base *ab)
{
...
int ath12k_core_pre_init(struct ath12k_base *ab)
{
	...
	ret = ath12k_init_hw_params(ab);
	if (ret) {
		ath12k_err(ab, "failed to get hw params: %d\n", ret);
		return ret;
	}
